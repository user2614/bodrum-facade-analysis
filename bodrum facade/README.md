...
* **Narrative:** Proje, Bodrum evinin kültürel bir gelenekken yönetmeliklerle korunan ikonik bir imgeye dönüşüm sürecini ele almaktadır.
* **Core Message:** Mimari dokunun izlerinin hala devam ettiği; beyaz evlerde mavi/lacivert tonlarının, taş yapılarda ise beyaz/bej tonlarının baskın olduğu veriye dayalı olarak kanıtlanmıştır.
...
* **Design Rationale:** 
    * **1. Page:** Data sources and spatial distribution of preserved heritage sites.
    * **2. Page:** Scatter plot analysis for granular investigation of facade dimensions.
    * **3. Page:** Holistic visualization for morphological observation.
...
* **Data Processing & Analysis:** `Python`, `Pandas`, `NumPy`, `OpenCV-Python`.
* **Visualization & Frontend:** **D3.js** (for interactive dashboards and dynamic data exploration), `Matplotlib`, `Seaborn`, `Folium` (for spatial mapping).
* **Annotation & Data Collection:** `makesense.ai` (for pixel-accurate bounding box extraction).
* **Environment:** `Jupyter Notebook` / `Google Colab`.

## Data Collection & Ethics
* **Methodology:** This study relies on manual annotation and on-site documentation, adhering to academic ethical standards. No automated web scraping was utilized.
